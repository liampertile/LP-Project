...
# agregamos el parametro tokens con un carácter más,
...
def lexer(codigofuente):
    # no usar globales, porque tiene efectos de lado imprevisibles
    ...
    while final < len(codigofuente):
        ...
        # agregamos un parametro a la función para evitar globales
        ...
        if len(posibles_tokens) == 0:
            ...
            # agregamos parametros a la función para
            tokens = guardarToken(
